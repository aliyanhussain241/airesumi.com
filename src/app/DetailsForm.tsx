            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Aliyan Hussain"
              ...
              {userData.experience.map((exp, index) => (
                <div key={index} className="relative group">
                  <textarea
                    ...
                    placeholder={`Role ${index + 1}: e.g. Millan Agro Seed, 2024–Present.\nHandled graphic design, social media, meta ads...`}
                    value={exp}
                    onChange={(e) => {
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-8">
            ...
            <div>
                ...
                {certifications.map((cert, index) => (
                  <div key={index} className="relative group">
                    ...
                    {certifications.length > 1 && (
                      <button
                        onClick={() => setUserData({ ...userData, certifications: certifications.filter((_, i) => i !== index) })}
                        className="absolute top-1/2 -translate-y-1/2 right-4 text-gray-400 hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100"
                        type="button"
                      >
                        <Trash2 size={16} />
                      </button>
              ...
              <button
                onClick={() => setUserData({ ...userData, certifications: [...certifications, ""] })}
                className="mt-4 flex items-center justify-center gap-2 text-sm font-bold text-gray-600 bg-gray-50 border border-gray-100 hover:border-gray-200 hover:bg-gray-100 px-6 py-3 rounded-xl transition-colors w-full sm:w-auto"
              >
