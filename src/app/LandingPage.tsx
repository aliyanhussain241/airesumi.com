      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8 lg:pt-12 pb-12 sm:pb-16 lg:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-8 items-center">
           <div className="w-full relative z-10 text-center lg:text-left">
            ...
            <div className="relative w-full h-[380px] sm:h-[520px] lg:h-[680px] flex items-center justify-center mt-12 sm:mt-14 lg:mt-0 transform scale-[0.58] sm:scale-[0.78] lg:scale-90 origin-top lg:origin-center -mb-[110px] sm:-mb-[80px] lg:mb-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-32 relative">
        ...
        {(() => {
          const features = [
            ...
            { icon: Link2,    title: "Paste any job link",    desc: "We know the formula recruiters look for. Drop a job description and we pre-build your resume to match it.", cta: "Tailor my resume", href: "/resume-tailor", span: 2 },
