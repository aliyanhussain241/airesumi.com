  ...
  return (
    ...
    >
          ...
          <div id="sec-2" className="mb-12 scroll-mt-32">
            ...
            <p>airesumi provides an AI-powered resume building and career tools platform, including but not limited to:</p>
            <ul>
            ...
            <p>airesumi reserves the right to modify, suspend, or discontinue any part of the Service at any time with or without notice. We shall not be liable to you or any third party for any modification, suspension, or discontinuation of the Service.</p>
          </div>

          <div id="sec-3" className="mb-12 scroll-mt-32">
            <h2>3. Account Registration and Security</h2>
            <ul>
              <li><strong>Creating an Account:</strong> To access certain features of airesumi, you must create an account by providing a valid email address and password, or by using Google or LinkedIn OAuth authentication. You must be at least 16 years of age to create a airesumi account.</li>
              <li><strong>Account Accuracy:</strong> You agree to provide accurate, current, and complete information during registration and to keep your account information updated. airesumi is not responsible for problems caused by inaccurate account information.</li>
              <li><strong>Account Security:</strong> You are responsible for maintaining the confidentiality of your account credentials. You agree to notify airesumi immediately at info@airesumi.com if you become aware of any unauthorized use of your account or any security breach.</li>
          ...
          <div id="sec-4" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>Free Plan:</strong> airesumi offers a free plan that allows users to create, edit, and preview resumes with core functionality. Free plan users may create up to 3 resumes and access basic templates. Free plan features may be modified at any time.</li>
              <li><strong>Pro Subscription:</strong> airesumi Pro is a paid subscription that unlocks unlimited resumes, premium templates, PDF and DOCX downloads, the cover letter generator, advanced ATS analysis, and other premium features. Pro pricing is displayed on our Pricing page and may change with 30 days notice to existing subscribers.</li>
              <li><strong>Billing:</strong> Pro subscriptions are billed monthly or annually in advance. Payments are processed securely by Stripe. By subscribing to Pro, you authorize airesumi to charge your payment method on a recurring basis until you cancel.</li>
              ...
              <li><strong>Free Trial:</strong> If airesumi offers a free trial of Pro features, your payment method will be charged at the end of the trial period unless you cancel before the trial expires. Trial terms will be clearly stated at sign-up.</li>
            </ul>
          </div>

          <div id="sec-5" className="mb-12 scroll-mt-32">
            <h2>5. Acceptable Use Policy</h2>
            <p>You agree to use airesumi only for lawful purposes and in accordance with these Terms. You agree NOT to:</p>
            <ul>
              <li><strong>Misrepresent Information:</strong> Use airesumi to create resumes containing deliberately false, fabricated, or misleading work experience, qualifications, certifications, or educational credentials. While airesumi helps you present your real experience powerfully, we do not support fraud or misrepresentation.</li>
          ...
          <div id="sec-6" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>airesumi's Intellectual Property:</strong> The airesumi platform, including its design, code, AI models, resume templates, example library, written content, logos, and trademarks, is owned by airesumi and protected by copyright, trademark, and other intellectual property laws. You may not copy, reproduce, distribute, or create derivative works from airesumi's proprietary content without written permission.</li>
              <li><strong>Your Content:</strong> You retain full ownership of the personal content you provide to airesumi — including your work history, skills, education, and contact details. By using airesumi, you grant us a limited, non-exclusive license to process and store your content solely for the purpose of providing the Service to you.</li>
          ...
          <div id="sec-7" className="mb-12 scroll-mt-32">
            ...
            <p>airesumi uses artificial intelligence to generate resume content, cover letters, and interview preparation materials. By using our AI tools, you acknowledge and agree to the following:</p>
            <ul>
              ...
              <li><strong>Accuracy:</strong> AI-generated content reflects general best practices for resume writing. It does not constitute legal, career, financial, or professional advice. airesumi does not guarantee that any AI-generated resume will result in interviews, job offers, or employment.</li>
          ...
          <div id="sec-8" className="mb-12 scroll-mt-32">
            ...
            <p>TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, airesumi DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:</p>
            <ul>
            ...
            <p>airesumi does not warrant that your resume will pass any particular ATS system, result in interviews, or lead to employment. ATS systems vary by employer and are updated frequently. Our ATS scores are estimates based on general ATS behavior patterns and are not guarantees of actual ATS performance.</p>
          </div>

          <div id="sec-9" className="mb-12 scroll-mt-32">
            <h2>9. Limitation of Liability</h2>
            <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, airesumi AND ITS OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS SHALL NOT BE LIABLE FOR:</p>
            <ul>
              ...
              <li>Any damages exceeding the total amount you paid to airesumi in the 12 months preceding the claim</li>
            </ul>
            ...
            <p>Nothing in these Terms limits airesumi's liability for fraud, gross negligence, willful misconduct, or any liability that cannot be excluded under applicable law.</p>
          </div>

          <div id="sec-10" className="mb-12 scroll-mt-32">
            <h2>10. Termination</h2>
            <ul>
              <li><strong>Termination by You:</strong> You may terminate your airesumi account at any time by going to Account Settings and selecting Delete Account. Upon deletion, your personal data and resume content will be permanently deleted within 30 days.</li>
              <li><strong>Termination by airesumi:</strong> airesumi reserves the right to suspend or terminate your account immediately, without notice or liability, if you:
                <ul>
                  ...
                  <li>Attempt to harm the Service, other users, or airesumi</li>
                </ul>
              </li>
          ...
          <div id="sec-11" className="mb-12 scroll-mt-32">
            ...
            <ul>
              ...
              <li><strong>Informal Resolution:</strong> Before filing any formal legal claim, you agree to contact airesumi at info@airesumi.com to attempt to resolve the dispute informally. We will make good faith efforts to resolve disputes within 30 days.</li>
              <li><strong>Arbitration:</strong> If informal resolution fails, any dispute arising from these Terms or your use of airesumi shall be resolved through binding individual arbitration administered by the American Arbitration Association (AAA) under its Consumer Arbitration Rules. You waive your right to participate in class action lawsuits.</li>
          ...
          <div id="sec-12" className="mb-12 scroll-mt-32">
            ...
            <p>airesumi reserves the right to update these Terms of Service at any time. When we make material changes, we will:</p>
            <ul>
              <li>Update the 'Last Updated' date at the top of this page</li>
              <li>Send an email notification to all registered users at least 14 days before the changes take effect</li>
              <li>Display a prominent notice on the airesumi platform</li>
            </ul>
            ...
            <p>Your continued use of airesumi after the effective date of updated Terms constitutes your acceptance of those Terms. If you do not agree to the updated Terms, you must stop using the Service and delete your account before the effective date.</p>
          </div>
  ...
  return (
    ...
    >
          ...
          <div id="sec-1" className="mb-12 scroll-mt-32">
            ...
            <p>When you create a airesumi account or use our resume builder, we collect the following information that you provide directly:</p>
            <ul>
              <li><strong>Account Information:</strong> Your name, email address, and password when you register for a airesumi account. If you sign up using Google or LinkedIn OAuth, we receive your name and email from those services only.</li>
              ...
              <li><strong>Payment Information:</strong> If you subscribe to airesumi Pro, your payment is processed by Stripe. We never see or store your full credit card number. We receive only a payment confirmation token and your billing address from Stripe.</li>
          ...
          <div id="sec-3" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>Encryption:</strong> All data transmitted between your browser and airesumi is encrypted using TLS 1.3 (HTTPS). Your resume data stored on our servers is encrypted at rest using AES-256 encryption — the same standard used by banks and government agencies.</li>
              <li><strong>Server Security:</strong> airesumi is hosted on Amazon Web Services (AWS) with enterprise-grade security configurations, automatic backup systems, and 99.9% uptime guarantees. Our servers are located in the United States and the European Union.</li>
              <li><strong>Access Controls:</strong> Only authorized airesumi engineers with a legitimate business need can access user data, and only through secure authenticated channels with full audit logging. No airesumi employee can access your resume content without your permission.</li>
          ...
          <div id="sec-4" className="mb-12 scroll-mt-32">
            ...
            <p><strong>What Are Cookies:</strong> Cookies are small text files stored on your device by your browser. airesumi uses cookies to keep you logged in, remember your preferences, and understand how our service is used.</p>
            <h3>Types of Cookies We Use:</h3>
            <ul>
              <li><strong>Essential Cookies (Required):</strong> These cookies are necessary for airesumi to function. They keep you logged into your account and prevent cross-site request forgery attacks. You cannot disable these while using our service.</li>
              <li><strong>Analytics Cookies (Optional):</strong> We use Google Analytics and a self-hosted analytics tool to understand how users navigate airesumi, which features are most used, and where users encounter problems. This data is aggregated and anonymized. You can opt out of analytics cookies in your Account Settings.</li>
            ...
            <p><strong>How to Control Cookies:</strong> You can manage cookies through your browser settings at any time. Note that disabling essential cookies will prevent you from staying logged into your airesumi account.</p>
          </div>

          <div id="sec-5" className="mb-12 scroll-mt-32">
            <h2>5. Third Party Services We Use</h2>
            <p>airesumi uses a small number of trusted third-party services to operate our platform. Each has been evaluated for privacy compliance:</p>
            <ul>
          ...
          <div id="sec-6" className="mb-12 scroll-mt-32">
            ...
            <ul>
              ...
              <li><strong>Right to Deletion:</strong> You can delete your airesumi account and all associated data at any time from Account Settings → Delete Account. We permanently delete your data within 30 days. This includes your resume content, account information, and usage history.</li>
          ...
          <div id="sec-7" className="mb-12 scroll-mt-32">
            ...
            <p>airesumi is designed for adults and professional job seekers. Our service is not directed at children under the age of 16. We do not knowingly collect personal information from anyone under 16 years of age.</p>
            <p>If you are a parent or guardian and believe your child has provided personal information to airesumi, please contact us immediately at info@airesumi.com. We will delete the information promptly upon verification.</p>
          </div>

          <div id="sec-8" className="mb-12 scroll-mt-32">
            <h2>8. International Data Transfers</h2>
            <p>airesumi is operated from the United States. If you are accessing our service from outside the United States — including from the European Union, United Kingdom, Canada, Pakistan, India, Australia, or any other country — your data will be transferred to and processed in the United States.</p>
          ...
          <div id="sec-9" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li>Update the 'Last Updated' date at the top of this page</li>
              <li>Send an email notification to all registered airesumi users</li>
              <li>Display a notice on the airesumi homepage for 30 days after the change</li>
            </ul>
            <p>We encourage you to review this Privacy Policy periodically. Your continued use of airesumi after changes are posted constitutes your acceptance of the updated policy.</p>
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF7] font-sans selection:bg-[#FF6321] selection:text-white pb-20 pt-24">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-8">airesumi Company Information</h2>
        <div className="grid md:grid-cols-3 gap-6 mb-20">
        ...
        <div className="space-y-4 mb-20">
          {[
            { q: "Is airesumi completely free to use?", a: "Our core AI resume builder is free to use with no credit card required. You can create, edit, and preview your resume for free. Our Pro plan unlocks unlimited downloads, premium templates, the cover letter generator, and advanced ATS analysis. You can upgrade at any time from your account dashboard." },
            { q: "How do I download my resume as a PDF?", a: "Once you have built your resume in the airesumi builder, click the Download button in the top right corner of the editor. Free users can download one resume as a PDF. Pro users can download unlimited resumes in both PDF and DOCX format. If your download is not working, try using Google Chrome and disabling any ad blockers." },
            { q: "Can I cancel my Pro subscription at any time?", a: "Yes. You can cancel your airesumi Pro subscription at any time from your Account Settings page under Billing. Your Pro access continues until the end of your current billing period. We do not charge cancellation fees. If you have any trouble cancelling, email info@airesumi.com and we will process it within 2 hours." },
            ...
            { q: "Can I use airesumi for multiple resumes?", a: "Yes. Free users can create and save up to 3 resumes. Pro users can create unlimited resumes and tailor each one to a different job description. This is especially useful for job seekers applying to multiple roles or industries simultaneously." }
          ].map((faq, i) => (
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">
            We Are airesumi — Helping Job Seekers Get Hired Faster With AI
          </h1>
          <p className="text-xl text-gray-600 leading-relaxed font-medium">
            airesumi was built for one reason: too many qualified people were losing jobs to bad resumes. We built the smartest AI resume builder on the internet to fix that — for free.
          </p>
        </div>
