  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        { name: "description", content: `Read our guide on ${title.toLowerCase()}. Expert career advice, resume tips, and job search strategies from airesumi.` },
        { name: "robots", content: "index, follow" },
        { property: "og:title", content: `${title} | airesumi Career Blog` },
        { property: "og:description", content: `Read our guide on ${title.toLowerCase()}. Expert career advice from airesumi.` },
