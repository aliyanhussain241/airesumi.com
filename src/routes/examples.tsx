...
export const Route = createFileRoute("/examples")({
  head: () => ({
    meta: [
      { title: "Free ATS Resume Examples by Job Title & Industry | airesumi.com" },
      { name: "description", content: "Browse free ATS-optimized resume examples by job title, industry, and experience level. Download and customize for 2026 job applications." },
      { property: "og:title", content: "Free Resume Examples by Job Title | airesumi.com" },
      { property: "og:description", content: "Free ATS-optimized resume examples by job title and industry. Updated for 2026." },
